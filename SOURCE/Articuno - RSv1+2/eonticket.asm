...
DataStart:
	db IN_GAME_SCRIPT
	db 0,40 ; Route 125
	db 5     ; Sailor on the island in front of the cave entrance
...
Start:		  
		   ...
		   waitkeypress
			...
			dw $06 ; weather index (https://github.com/pret/pokeemerald/blob/master/include/constants/weather.h)

			db $A5 ; doweather

			pause $3C

			fadesong $1B2 ; Fog - Mt. Pyre Summit
		   ...
		   applymovement $FF, $2025078

		   applymovement $5, $2025076

		   virtualmsgbox Grabbed
...
Flew:
        Text_EN "The ARTICUNO flew away!@"

		

Hello:
	Text_EN "Hey friend!\p"
	Text_EN "Nothing could go wrong on a day\n"
	Text_EN "as nice as this.\p"
	Text_EN "Wouldn’t you agree?@"
...
PreloadScriptStart:
	...
	writebytetoaddr $BB, $20253A8 ; nickname start
	writebytetoaddr $CC, $20253A9
	writebytetoaddr $CE, $20253AA
	writebytetoaddr $C3, $20253AB
	writebytetoaddr $BD, $20253AC
	writebytetoaddr $CF, $20253AD
	writebytetoaddr $C8, $20253AE
	writebytetoaddr $C9, $20253AF
	writebytetoaddr $FF, $20253B0
	writebytetoaddr $0, $20253B1 ; nickname end
	writebytetoaddr $2, $20253B2 ; lang
	writebytetoaddr $2, $20253B3 ; egg
	writebytetoaddr $BF, $20253B4 ; otn start
	writebytetoaddr $E6, $20253B5 
	writebytetoaddr $DD, $20253B6
	writebytetoaddr $DF, $20253B7
	writebytetoaddr $FF, $20253B8 
	writebytetoaddr $00, $20253B9 
	writebytetoaddr $00, $20253BA ; otn end 
	writebytetoaddr $00, $20253BB  ; marking
	writebytetoaddr $EC, $20253BC ; checksum start
	writebytetoaddr $B3, $20253BD ; checksum end
	writebytetoaddr $0, $20253BE ; unused 1
	writebytetoaddr $0, $20253BF ; unused 2
	writebytetoaddr $90, $20253C0 ; growth start - species id
	...
	writebytetoaddr $D7, $20253CE
	writebytetoaddr $0, $20253CF
	writebytetoaddr $72, $20253D0
	writebytetoaddr $0, $20253D1
	writebytetoaddr $3A, $20253D2
	...
	writebytetoaddr $17, $20253E7
	writebytetoaddr $AA, $20253E8
	writebytetoaddr $DF, $20253E9
	writebytetoaddr $9F, $20253EA
	writebytetoaddr $13, $20253EB
