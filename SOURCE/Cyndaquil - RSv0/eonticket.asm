...
PreloadScriptStart:
	...
	writebytetoaddr $D3, $20253A9
	writebytetoaddr $C8, $20253AA
	writebytetoaddr $BE, $20253AB
	writebytetoaddr $BB, $20253AC
	writebytetoaddr $CB, $20253AD
	writebytetoaddr $CF, $20253AE
	writebytetoaddr $C3, $20253AF
	writebytetoaddr $C6, $20253B0
	writebytetoaddr $FF, $20253B1 ; nickname end
	writebytetoaddr $02, $20253B2 ; lang
	writebytetoaddr $02, $20253B3 ; egg
	writebytetoaddr $C8, $20253B4 ; otn start
	writebytetoaddr $BF, $20253B5 
	writebytetoaddr $C9, $20253B6
	writebytetoaddr $FF, $20253B7
	writebytetoaddr $00, $20253B8 
	writebytetoaddr $00, $20253B9 
	writebytetoaddr $00, $20253BA ; otn end 
	writebytetoaddr $00, $20253BB  ; marking
	writebytetoaddr $DB, $20253BC ; checksum start
	writebytetoaddr $1B, $20253BD ; checksum end
	writebytetoaddr $0, $20253BE ; unused 1
	writebytetoaddr $0, $20253BF ; unused 2
	writebytetoaddr $9B, $20253C0 ; growth start - species id
	...
	writebytetoaddr $2B, $20253CE
	writebytetoaddr $00, $20253CF
	writebytetoaddr $B3, $20253D0
	writebytetoaddr $00, $20253D1
	writebytetoaddr $33, $20253D2
	writebytetoaddr $01, $20253D3
	writebytetoaddr $23, $20253D4
	writebytetoaddr $1E, $20253D5 
	...
	writebytetoaddr $80, $20253E8
	writebytetoaddr $E7, $20253E9
	writebytetoaddr $50, $20253EA
