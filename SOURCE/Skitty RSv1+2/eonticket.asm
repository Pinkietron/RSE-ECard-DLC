...
GoSeeYourFather:
	Text_EN "Take a visit to the MAUVILLE CITY\n"
	Text_EN "GAME CORNER.@"
...
SaidYes:
		...
		setflag $20 ; accepted the challenge		
...
Flew:
        Text_EN "SKITTY hid somewhere!@"

	
Hello:
	Text_EN "My daddy gave me a special SKITTY.\p"
	Text_EN "It doesn’t like me very much.\p"
	Text_EN "I’ll give it to you if you can\n"
	Text_EN "promise one thing.@"

NextTime:
	Text_EN "Maybe another trainer...@"

Care:
	Text_EN "Do you promise to treat all POKéMON\n"
	Text_EN "with love and care?@"

Released:
	Text_EN "Come on out, SKITTY!@"

Caught:
	Text_EN "Goodbye SKITTY...@"

Alright:
	Text_EN "If you say so.@"
...
PreloadScriptStart:
	...
	writebytetoaddr $CD, $20253A8 ; nickname start
	writebytetoaddr $C5, $20253A9
	writebytetoaddr $C3, $20253AA
	writebytetoaddr $CE, $20253AB
	writebytetoaddr $CE, $20253AC
	writebytetoaddr $D3, $20253AD
	...
	writebytetoaddr $97, $20253BC ; checksum start
	writebytetoaddr $8B, $20253BD ; checksum end
	writebytetoaddr $0, $20253BE ; unused 1
	writebytetoaddr $0, $20253BF ; unused 2
	writebytetoaddr $3B, $20253C0 ; growth start - species id
	writebytetoaddr $01, $20253C1
	writebytetoaddr $00, $20253C2
	writebytetoaddr $00, $20253C3
	writebytetoaddr $D4, $20253C4
	writebytetoaddr $30, $20253C5
	...
	writebytetoaddr $2D, $20253CC ; attacks start
	writebytetoaddr $00, $20253CD 
	writebytetoaddr $21, $20253CE
	writebytetoaddr $00, $20253CF
	writebytetoaddr $27, $20253D0
	writebytetoaddr $00, $20253D1
	writebytetoaddr $06, $20253D2
	writebytetoaddr $00, $20253D3
	writebytetoaddr $28, $20253D4
	writebytetoaddr $23, $20253D5 
	writebytetoaddr $1E, $20253D6 
	writebytetoaddr $14, $20253D7 ; attacks end
	...
	writebytetoaddr $47, $20253E8
	writebytetoaddr $DC, $20253E9
	writebytetoaddr $00, $20253EA
	writebytetoaddr $27, $20253EB
	...
	writebytetoaddr $81, $2025034 ; 81 in v1+2, 61 in v0
