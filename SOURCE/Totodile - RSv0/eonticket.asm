...
PreloadScriptStart:
	...
	writebytetoaddr $CE, $20253A8 ; nickname start
	writebytetoaddr $C9, $20253A9
	writebytetoaddr $CE, $20253AA
	writebytetoaddr $C9, $20253AB
	writebytetoaddr $BE, $20253AC
	writebytetoaddr $C3, $20253AD
	writebytetoaddr $C6, $20253AE
	writebytetoaddr $BF, $20253AF
	...
	writebytetoaddr $2E, $20253BC ; checksum start
	writebytetoaddr $F2, $20253BD ; checksum end
	writebytetoaddr $0, $20253BE ; unused 1
	writebytetoaddr $0, $20253BF ; unused 2
	writebytetoaddr $9E, $20253C0 ; growth start - species id
	...
	writebytetoaddr $F2, $20253CC ; attacks start
	writebytetoaddr $00, $20253CD 
	writebytetoaddr $0A, $20253CE
	writebytetoaddr $00, $20253CF
	writebytetoaddr $2B, $20253D0
	writebytetoaddr $00, $20253D1
	writebytetoaddr $34, $20253D2
	...
	writebytetoaddr $AE, $20253E8
	writebytetoaddr $C3, $20253E9
	writebytetoaddr $4E, $20253EA
